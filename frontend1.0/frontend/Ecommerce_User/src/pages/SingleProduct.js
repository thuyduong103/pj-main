...
const SingleProduct = () => {
 ...
 useEffect(() => {
  ...
  if (savedWishlist.includes(getProductId)) {
    setHeart(true); // Set heart to true if product is in the wishlist
  } else {
    setHeart(false);
  }
}, [getProductId]);
...
const handleWishlistToggle = () => {
  ...
  if (heart) {
    ...
    const updatedWishlist = savedWishlist.filter((id) => id !== getProductId);
    localStorage.setItem("wishlist", JSON.stringify(updatedWishlist));
  } else {
    // Add product to wishlist
    savedWishlist.push(getProductId);
    localStorage.setItem("wishlist", JSON.stringify(savedWishlist));
  }

  setHeart(!heart); // Toggle heart state
};
const [heart, setHeart] = useState(false); // State for heart (wishlist)
            ...
            <div className="main-product-details">
              ...
              <div className=" py-3">
                ...
                <div className="d-flex align-items-center gap-15">
                  ...
                  <button onClick={handleWishlistToggle} className="border-0 bg-transparent">
                    <AiOutlineHeart
                      className="fs-5 me-2"
                      color={heart ? "pink" : "gray"} // Heart color changes based on wishlist status
                    />
                  </button>
                </div>
